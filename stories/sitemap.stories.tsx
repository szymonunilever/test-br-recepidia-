...
storiesOf('Components/Sitemap', module)
  .add('Sitemap default', () => <Sitemap content={content} />, {
    info: { inline: false },
  })
  .add(
  ...
  .add(
    'Sitemap with multiple nesting levels',
    () => (
      <Sitemap title={'Multiple nesing levels'} content={multipleNesting} />
    ),
    { info: { inline: false } }
  );
