...
storiesOf('Components/Form elements/All', module).add(
  'Form contact us',
  () => (
          ...
          <form onSubmit={handleSubmit}>
                ...
                >
                  <label className="field-label">
                    ...
                    {meta.error && meta.touched && (
                      <span className="field-error-message">{meta.error}</span>
                    )}
                  </label>
            ...
            <fieldset className="field">
              ...
              <div className="field-wrap field-wrap--inline">
                <Field name="specific" validate={required('Field is required')}>
                  {({ input, meta }) => (
                    <div
