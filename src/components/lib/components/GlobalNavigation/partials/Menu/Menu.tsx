  ...
  const handleKeyUpMenu = (
    ...
    switch (e.keyCode) {
      ...
      case KeyCode.ArrowDown:
        if (isSubmenuList && e.currentTarget.className === 'menu__link') {
          keyBoardOpenSubmenu(e.currentTarget, i);
        } else if (e.currentTarget.className === 'submenu__link') {
          const {
            currentMenuSize,
            currentTabIndex,
            currentLinkIndex,
      ...
      case KeyCode.ArrowRight:
        if (e.currentTarget.className === 'menu__link') {
          ...
          isSubmenuList &&
          e.currentTarget.className === 'submenu__link'
        ) {
          keyBoardOpenSubmenu(e.currentTarget, i);
        }
        break;
      case KeyCode.ArrowLeft:
        ...
        if (e.currentTarget.className === 'submenu__link') {
          const counterToRoot = countToRoot(e.currentTarget);
          if (counterToRoot === 3) {
